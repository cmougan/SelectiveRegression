...
coverage = 0.8
# %%
for dataset in regression_dataset_names[3:5]:
    try:
...
plt.xlabel("Coverage")
plt.legend()
plt.savefig("images/pmlb_performance.pdf", bbox_inches="tight")
# plt.show()
...
plt.xlabel("Coverage")
plt.legend()
plt.savefig("images/pmlbBenchmark_coverage.pdf", bbox_inches="tight")
# plt.show()
